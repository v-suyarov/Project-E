...
namespace MoreMountains.CorgiEngine
{
    ...
    public class GlowwormFollow : MonoBehaviour
    {
        ...
        [Tooltip("Ќасколько далеко cветл€чок будет отлетать от персонажа")]
        [SerializeField] private float distanse = 4f;
        [Tooltip("¬ыбор функции вли€ет на траекторию полета")]
        [SerializeField] private FlightBehavior flightBehavior;
        [Tooltip("ѕереод функции")]
        [SerializeField] float  period = 2;
        [Tooltip("”множает функцию на указанное значение")]
        [SerializeField] private float multiply =1f;
        [Tooltip("—корость полета")]
        [SerializeField] private float speed;
        //[Tooltip("—двиг светл€чка в состо€нии поко€")]
